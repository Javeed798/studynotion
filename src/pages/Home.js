    ...
    return (
        <div>
            ...
            <div className="relative mx-auto flex w-11/12 max-w-maxContent flex-col items-center justify-between gap-8 text-white">
                ...
                <div>
                    <CodeBlocks
                        position={"lg:flex-row-reverse items-center"}
                        heading={
                            <div className="text-4xl font-semibold">
                                Start
            ...
            <div className={"bg-pure-greys-5 text-richblack-700"}>
                <div className={"homepage_bg h-[310px] items-center"}>
                ...
                <div className={"mx-auto w-11/12 max-w-maxContent gap-7 flex flex-col items-center justify-between"}>
            ...
            <div className="relative mx-auto my-20 flex w-11/12 max-w-maxContent flex-col items-center justify-between gap-8 bg-richblack-900 text-white">                <InstructorSection />
